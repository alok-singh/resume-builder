...
const Aurora = (props) => {
 ...
 return (
    <div style={props.style} className="h-full font-eb-garamond text-slate-900 bg-white">
      <div className="min-h-full flex flex-col" style={{ backgroundColor: `${templateThemeBgColor}30` }}>
