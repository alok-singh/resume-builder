...
const SectionHeading = ({ children }) => {
  return (
    <div className="mb-4">
      <h2 className="text-sm font-semibold tracking-widest text-slate-700 uppercase">{children}</h2>
...
const Celestial = (props) => {
  ...
  return (
    <div className={`min-h-full aspect-[1/1.4142] font-montserrat bg-white`}>
      <div className="min-h-full flex">
        {/* Sidebar */}
        <aside className="w-[34%] px-7 py-10" style={{ backgroundColor: props?.templateThemeColor?.bg || 'rgb(242, 242, 242)', color: props?.templateThemeColor?.txt || '#333333' }}>
          ...
          {/* Details */}
          <div className="mt-8">
            <h2 className="text-sm font-semibold tracking-widest uppercase" style={{ color: props?.templateThemeColor?.txt || '#314158' }}>Details</h2>
            <div className="mt-2 mb-4 border-b border-slate-300" />
          ...
          {skills.length > 0 && (
            <div className="mt-8">
              <h2 className="text-sm font-semibold tracking-widest uppercase" style={{ color: props?.templateThemeColor?.txt || '#314158' }}>
                Skills
              </h2>
              <div className="mt-2 mb-4 border-b border-slate-300" />
        ...
        {/* Main content */}
        <main className="w-[66%] px-9 py-10">
          {/* Summary */}
          {summary && (
